    ...
    func takeScreenshot() {
        func saveImage(image: UIImage) {
            PHPhotoLibrary.shared().performChanges({
                ...
                if let e = error {
                    HUG.show(title: "Save fail", message: e.localizedDescription)
                } else{
                    HUG.show(title: "Save success")
                }
            }
        }
        ...
        default:
            PHPhotoLibrary.requestAuthorization { (status) in
                ...
                case .authorized:
                    saveImage(image: image)
                default:
                    HUG.show(title: "Save fail", message: "Please open the album permissions in the Settings")
                }
            }
        }
    }
