...
/// According to point cloud fitting plane
/// - Parameters:
/// - Returns:
///   - featureCloud： Point Cloud
/// - Returns: Plane normal vector and a point on the plane
...
/// Calculate intersections based on points and vectors on a line and points and normals on a plane
/// - Parameters:
///   - planeVector: Plane normal vector
///   - planePoint: A little bit on the plane
///   - lineVector: Straight line vector
///   - linePoint: Straight line
...
// Point cloud fitting polygon to find the area
/// - Parameters:
...
// Spatial polygon area
/// - Parameters:
///   - points: Vertex coordinates
///   - plane: The plane where the polygon is located
/// - Returns: area
